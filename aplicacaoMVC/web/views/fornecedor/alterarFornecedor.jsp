            ...
            <form action="alterarFornecedor" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input required
                        ...
                        value="<%=fornecedor.getRazaoSocial()%>"
                    />
