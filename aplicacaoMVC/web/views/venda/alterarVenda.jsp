        ...
        <div class="col-sm-6 mt-5 mb-5">
            <form action="alterarVenda" method="post">
                <div class="mb-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="id_venda" value="<%= venda.getId() %>">
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" class="form-control" id="id_cliente" name="id_cliente" value="<%= venda.getCliente().getId()%>">
                    <input type="text" class="form-control" id="cliente_nome" name="cliente" value="<%= venda.getCliente().getNome() %>" disabled>
