...
public class Produto {
    ...
    public Produto(int id,String nome, String descricao, float precoCompra, float precoVenda, int quantidadeDisponivel, String liberadoVenda, Categoria categoria) {
